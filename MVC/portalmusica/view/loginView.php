...
<body>
    ...
    <div class="container ">
		...
		<div class="form-group">
			Número del empleado <input type="text" name="email" placeholder="example@example.com" class="form-control">
        </div>
		<div class="form-group">
			Clave <input type="password" name="lastName" placeholder="password" class="form-control">
        </div>				
